    ...
    st.markdown(f"""
        <div class="ros-header">
            <div style="display: flex; align-items: center; flex-wrap: wrap;">
                {logo_html}
                <div style="font-size: 22px; font-weight: bold; white-space: nowrap;">РОСКАЧЕСТВО</div>
                <div style="margin-left: 20px; font-size: 16px; border-left: 1px solid white; padding-left: 20px;" class="header-subtitle">
                    Аналитическая панель
                </div>
            </div>
            <div style="font-size: 13px; text-align: right;" class="header-info">
